# LeetCode Solution: Maximum Average Subarray I
...
👉 https://leetcode.com/problems/maximum-average-subarray-i/solutions/7373131/simple-sol-with-logic-explaination-by-vi-avhs/
...
- **Difficulty:** Easy  
- **Key Concept:** Maintain window sum of size `k`  
- **Solution:** Use sliding window to compute max average  

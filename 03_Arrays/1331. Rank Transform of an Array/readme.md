```md
# LeetCode Solution: Rank Transform of an Array
...
👉 https://leetcode.com/problems/rank-transform-of-an-array/solutions/7484038/very-easy-sol-with-logic-explaination-by-0a3g/

## Quick Overview
- **Problem Type**: Array, Hash Map  
- **Difficulty**: Easy  
- **Key Concept**: Coordinate compression / ranking  
- **Solution Summary**:  
  Sort the unique values of the array.  
  Use a map to assign each value a **rank** based on its position in the sorted list.  

...
👉 https://leetcode.com/problems/maximum-product-of-two-elements-in-an-array/solutions/7493613/very-simple-sol-with-logic-explaination-bk3sh/

## Quick Overview
- **Problem Type**: Array  
- **Difficulty**: Easy  
- **Key Concept**: Two largest values  
- **Solution Summary**:  
  Find the **two largest numbers** in the array.  
  The maximum product after subtracting 1 from each is:  
  \[
  (max1 - 1) \times (max2 - 1)
  \]

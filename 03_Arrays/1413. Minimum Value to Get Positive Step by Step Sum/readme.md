# LeetCode Solution: Minimum Value to Get Positive Step by Step Sum
...
👉 https://leetcode.com/problems/minimum-value-to-get-positive-step-by-step-sum/solutions/7496405/very-simple-sol-with-logic-explaination-shbyq/

## Quick Overview
- **Problem Type**: Array, Prefix Sum  
- **Difficulty**: Easy  
- **Key Concept**: Running minimum sum  
- **Solution Summary**:  
  Track the **running sum** of the array.  
  If the minimum running sum ever falls below 1, the result is `1 - minSum`; otherwise `1`.

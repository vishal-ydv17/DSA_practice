```md
# LeetCode Solution: Find the Town Judge
...
👉 https://leetcode.com/problems/find-the-town-judge/solutions/7454056/very-simple-sol-with-logic-explaination-2iclt/

## Quick Overview
- **Problem Type**: Graph, In-Degree / Out-Degree  
- **Difficulty**: Easy  
- **Key Concept**: Trust counts  
- **Solution Summary**:  
  Track for each person:
  - how many people **trust them** (in-degree),
  - how many people they **trust** (out-degree).  
  The town judge is trusted by `n-1` people and trusts **no one**.  
  Return the index of such a person, or `-1` if none found.

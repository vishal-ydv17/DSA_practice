...
👉 https://leetcode.com/problems/slowest-key/solutions/7517668/very-simple-sol-with-logic-sol-with-expl-k5yg/

## Quick Overview
- **Problem Type**: Simulation, Array  
- **Difficulty**: Easy  
- **Key Concept**: Track longest press duration  
- **Solution Summary**:  
  Find the key with the **maximum press duration**.  
  If multiple keys have the same duration, return the one with the **largest lexicographical value**.

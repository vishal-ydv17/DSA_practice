# LeetCode Solution: Count Good Triplets
...
👉 https://leetcode.com/problems/count-good-triplets/solutions/7498934/very-simple-sol-with-logic-explaination-q4coi/

## Quick Overview
- **Problem Type**: Array, Brute Force  
- **Difficulty**: Easy  
- **Key Concept**: Triple nested comparison  
- **Solution Summary**:  
  Count all triplets `(i, j, k)` where `i < j < k` and the absolute differences satisfy the given constraints.

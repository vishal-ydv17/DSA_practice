...
👉 https://leetcode.com/problems/number-of-good-pairs/solutions/7498831/very-simple-sol-withexplaination-by-vish-rrq0/

## Quick Overview
- **Problem Type**: Array, Hash Map  
- **Difficulty**: Easy  
- **Key Concept**: Counting pairs with same value  
- **Solution Summary**:  
  Use a hash map to count frequency of each number.  
  For each number with frequency `freq`, add `freq * (freq - 1) / 2` to result.

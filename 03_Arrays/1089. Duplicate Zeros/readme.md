```md
# LeetCode Solution: Duplicate Zeros
...
👉 https://leetcode.com/problems/duplicate-zeros/solutions/7469118/very-simple-sol-with-logic-explaination-5mtn6/
...
- **Solution Summary**:  
  Duplicate each `0` in the array by shifting elements to the right.  
  Preserve the original array length while shifting.

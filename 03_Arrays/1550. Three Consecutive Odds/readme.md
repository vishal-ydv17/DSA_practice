# LeetCode Solution: Three Consecutive Odds
...
👉 https://leetcode.com/problems/three-consecutive-odds/solutions/7506603/very-simple-sol-with-logic-explaination-1mge2/

## Quick Overview
- **Problem Type**: Array  
- **Difficulty**: Easy  
- **Key Concept**: Sliding count of odd numbers  
- **Solution Summary**:  
  Traverse the array and count consecutive odd numbers.  
  If you find three in a row, return `true`; otherwise return `false`.

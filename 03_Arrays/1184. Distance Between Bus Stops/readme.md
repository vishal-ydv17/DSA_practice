```md
# LeetCode Solution: Distance Between Bus Stops
...
👉 https://leetcode.com/problems/distance-between-bus-stops/solutions/7471636/very-simple-sol-with-logic-explaination-5opqw/

## Quick Overview
- **Problem Type**: Array, Prefix Sum  
- **Difficulty**: Easy  
- **Key Concept**: Circular array distance  
- **Solution Summary**:  
  Compute the sum of distances in order and compare with the total minus that distance to get the minimum circular path.

...
👉 https://leetcode.com/problems/lucky-numbers-in-a-matrix/solutions/7488392/very-simple-sol-with-logic-explaination-bgbkt/

## Quick Overview
- **Problem Type**: Array, Matrix  
- **Difficulty**: Easy  
- **Key Concept**: Row minimum and column maximum  
- **Solution Summary**:  
  A *lucky number* is one that is **the minimum in its row** and **the maximum in its column**.  
  Find the row minima and column maxima, then collect values that satisfy both.

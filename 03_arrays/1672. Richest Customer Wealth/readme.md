# LeetCode Solution: Richest Customer Wealth
...
👉 https://leetcode.com/problems/richest-customer-wealth/solutions/7533283/very-simple-sol-with-logic-explaination-9cay9/

## Quick Overview
- **Problem Type**: Array  
- **Difficulty**: Easy  
- **Key Concept**: Row sum and max  
- **Solution Summary**:  
  For each customer (row), sum their account balances.  
  Return the **maximum total wealth** among all customers.

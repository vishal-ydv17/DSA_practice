```md
# LeetCode Solution: Minimum Subsequence in Non-Increasing Order
...
👉 https://leetcode.com/problems/minimum-subsequence-in-non-increasing-order/solutions/7492113/very-simple-sol-with-logic-explaination-btl6r/

## Quick Overview
- **Problem Type**: Array, Greedy  
- **Difficulty**: Easy  
- **Key Concept**: Sorting + Greedy pick  
- **Solution Summary**:  
  Sort the array in **descending** order and keep adding elements to the subsequence until its sum becomes **greater** than the sum of the remaining elements.

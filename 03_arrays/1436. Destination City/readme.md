```md
# LeetCode Solution: Destination City
...
👉 https://leetcode.com/problems/destination-city/solutions/7492779/very-simple-sol-with-logic-explaination-4m3qm/

## Quick Overview
- **Problem Type**: Hash Map  
- **Difficulty**: Easy  
- **Key Concept**: Build incoming/outgoing set  
- **Solution Summary**:  
  From the list of directed paths, the destination city is the one that **never appears as a starting city**.

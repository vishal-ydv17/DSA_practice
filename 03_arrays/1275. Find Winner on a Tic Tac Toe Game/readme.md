```md
# LeetCode Solution: Find Winner on a Tic-Tac-Toe Game
...
👉 https://leetcode.com/problems/find-winner-on-a-tic-tac-toe-game/solutions/7483684/very-simple-sol-with-logic-explaination-6qgyf/

## Quick Overview
- **Problem Type**: Array, Simulation  
- **Difficulty**: Easy  
- **Key Concept**: Count rows/cols/diagonals  
- **Solution Summary**:  
  Track counts of X and O for each **row**, **column**, and both **diagonals**.  
  Check if any count reaches 3 for a winner.

```md
# LeetCode Solution: Count Negative Numbers in a Sorted Matrix
...
👉 https://leetcode.com/problems/count-negative-numbers-in-a-sorted-matrix/solutions/7486213/very-simple-sol-with-logic-explaination-nhry3/

## Quick Overview
- **Problem Type**: Array, Matrix  
- **Difficulty**: Easy  
- **Key Concept**: Efficient traversal of sorted rows  
- **Solution Summary**:  
  Each row is sorted in **non-increasing order**.  
  Start from bottom-left or top-right and count negatives efficiently without scanning all elements.

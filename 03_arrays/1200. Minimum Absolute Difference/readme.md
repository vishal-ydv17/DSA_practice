```md
# LeetCode Solution: Minimum Absolute Difference
...
👉 https://leetcode.com/problems/minimum-absolute-difference/solutions/7473995/very-simple-sol-with-logic-explaination-2iw5e/

## Quick Overview
- **Problem Type**: Array, Sorting  
- **Difficulty**: Easy  
- **Key Concept**: Sorted consecutive difference  
- **Solution Summary**:  
  Sort the array, find the minimum absolute difference between adjacent elements, then collect all pairs that match this minimum difference.
